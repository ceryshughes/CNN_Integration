...
conda run -n fresh --no-capture-output python3.8 train_cnn.py 1 saved_models/run_seed_1 ../klatt_synthesis/sounds_pulse_voicing_artificial_closure_dur/ laff_vcv/sampled_stop_categories_pulse_voicing_artificial_closure_dur.csv > run_seed_1_out.txt 
